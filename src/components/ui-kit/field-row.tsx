...
export const fieldInputClass =
  "h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-base text-brand-dark outline-none transition-colors placeholder:text-slate-400 focus-visible:border-brand focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:bg-slate-50 disabled:opacity-60";
